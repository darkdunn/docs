...
Call [`PluginDocAPI.getSelectedText`](/api-reference/supernote-plugin/plugin-doc-api/get-selected-text) to get the currently selected text.
...
Call [`PluginDocAPI.getCurrentDocText`](/api-reference/supernote-plugin/plugin-doc-api/get-current-doc-text) to get the text content of a specified page in the currently opened document. Based on it, you can do full-page translation, key-point extraction, terminology highlighting, and more.
