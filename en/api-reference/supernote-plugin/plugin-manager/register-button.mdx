...
| `button` | [`PluginButton`](/api-reference/supernote-plugin/types/plugin-button) | Button configuration object |
...
- For more details, see: [Plugin UI - Button Event Listener](/plugin-base/plugin-ui)
