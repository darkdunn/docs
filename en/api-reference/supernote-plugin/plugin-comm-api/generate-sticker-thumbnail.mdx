...
| `size` | [`Size`](/api-reference/supernote-plugin/types/size) | thumbnailsize(keep the same aspect ratio as the original image),canvia [`getStickerSize`](/api-reference/supernote-plugin/plugin-comm-api/get-sticker-size)thisAPIGet sticker size|
