...
- [`APIResponse<object>`](/en/api-reference/supernote-plugin/types/api-response):`result` as followsfieldobject
 - [`APIResponse<object>`](/en/api-reference/supernote-plugin/types/api-response): `result` is an object with the following fields
