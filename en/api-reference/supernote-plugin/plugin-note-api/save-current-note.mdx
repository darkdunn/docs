...
If you call file-related APIs without saving (e.g. [`replaceElements`](/api-reference/supernote-plugin/plugin-file-api/replace-trails),
[`insertElements`](/api-reference/supernote-plugin/plugin-file-api/insert-trails)、
[`modifyElements`](/api-reference/supernote-plugin/plugin-file-api/modify-trails) etc.),
