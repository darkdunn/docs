...
| `elements` | [`Element[]`](/en/api-reference/supernote-plugin/types/trail) | elementdataarray |

**Returns**

- [`APIResponse<boolean>`](/en/api-reference/supernote-plugin/types/api-response):`result === true` indicatesreplacesuccess
