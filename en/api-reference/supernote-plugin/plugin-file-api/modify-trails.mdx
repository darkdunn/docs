...
| `elements` | [`Element[]`](/en/api-reference/supernote-plugin/types/trail) | requiredModify elementarray(Mustalready exists) |

**Returns**

- [`APIResponse<number[]>`](/en/api-reference/supernote-plugin/types/api-response):`result` is Modify success elementindexlist
