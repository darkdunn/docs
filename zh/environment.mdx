...
下载并安装 [`Android Studio`](https://developer.android.com/studio)。建议使用 Android Studio Narwhal | 2025.1.2 或更高版本，避免因版本过旧导致构建失败。
...
注：SDK Manager 还可以在 Android Studio 的"Preferences"菜单中找到。具体路径是File → Settings → Languages & Framework → Android SDK。
