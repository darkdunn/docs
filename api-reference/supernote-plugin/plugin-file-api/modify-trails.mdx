...
- [`APIResponse<number[]>`](/api-reference/supernote-plugin/types/api-response)：`result` 为修改成功的元素索引列表

## 示例

```ts wrap
import { PluginFileAPI, ElementType, type Element } from 'rtn-supernote-plugin-core';
