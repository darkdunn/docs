...
- [`APIResponse<boolean>`](/api-reference/supernote-plugin/types/api-response)：`result === true` 表示修改成功

## 示例

```ts wrap
import { PluginNoteAPI, type TextBox } from 'rtn-supernote-plugin-core';
